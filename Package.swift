...
let package = Package(
    ...
    targets: [
      .target(name: "mathbattleback", dependencies: [ .target(name: "Application") ]),
      .target(name: "Application", dependencies: [ "Kitura", "HeliumLogger", "CloudEnvironment","SwiftMetrics", "CredentialsJWT", "Health"
